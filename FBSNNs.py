"""
@author: Maziar Raissi, augmented by Ben Marrow
"""

import numpy as np
import tensorflow.compat.v1 as tf # Load Older Version of TensorFlow
import time
...
class FBSNN(ABC): # Forward-Backward Stochastic Neural Network
    ...
    def loss_function(self, t, W, Xi): # M x (N+1) x 1, M x (N+1) x D, 1 x D
        ...
        Z = tf.stack(Z_list,axis=1)  # Added by BM
